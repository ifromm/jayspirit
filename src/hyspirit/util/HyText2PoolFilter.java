...
public class HyText2PoolFilter {
    ...
    private Logger LOG = Logger.getLogger(HyText2PoolFilter.class);
 
    /**
     * Constructor of class.
     * @param hyspirit the HySpirit environment
     * @param stemming whether stemming should be applied
     * @param stopwordFile absoulte name of a stop word file; null if no
     *        stop word elimination should take place
     * @param morphemeFile absolute name of a morpheme file; null if
     *        there are none.
     * @throws HySpiritException if something goes wrong       
     */
    ...
    throws HySpiritException {
        ...
        if (stopwordFile != null) hytext2pool.addStopwordFile(stopwordFile);
        if (morphemeFile != null) hytext2pool.addMorphemeFile(morphemeFile);
     ...
     * @param hytext2pool the HyText2Pool object
     */
        ...
        if (text != null && !text.equals("")) {
            ...
            if (filteredText != null) {
                ...
                while (tokenizer.hasMoreTokens()) {
                    ...
                    if (!token.equals("NOT")) list.add(token);
                }
                it = list.iterator();   
            }
        }
