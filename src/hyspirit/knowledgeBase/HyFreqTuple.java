...
/**
 * This class represents a tuples as to be found in frequency files. Each tuple
...
public class HyFreqTuple implements Comparable{
    ...
    /**
     * Constructor of class. This constructor takes a line from a frequency
     * file
     * <br>
    ...
    public int compareTo(Object tupleObj) {
        ...
        if (tuple.frequency() > this.frequency()) return 1;
        else if (tuple.frequency() < this.frequency()) return -1;
        else return 0;
    }
