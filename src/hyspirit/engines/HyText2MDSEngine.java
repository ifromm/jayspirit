...
public class HyText2MDSEngine extends HyEngine {
    ...
    private static final String ENGINE_NAME = "hy_text2mds";
     ...
     * @param hyper flag if fast version should be used or not
     */
    public void hyper(boolean hyper) {
        if (hyper) this.hyper = "hyper";
        else this.hyper = "nohyper";
    }
     ...
     * (cwa = true). See hy_text2mds manual for further details. 
    ...
    /**
     * Sets the minimum word length. See hy_text2mds manual for further
     * details.
     * @param minWordLength
     */
    ...
    /**
     * Sets the maximum word length. See hy_text2mds manual for further
     * details.
     * @param maxWordLength
     */
     ...
     * wordSep() does not have any effect. See hy_text2mds manual for
     * further details.
     * @param wordRegex
     */
    ...
    protected String[] buildCommand() {
        ...
        if (hyper != null) commandVec.add(hyper);
        if (context != null) {
