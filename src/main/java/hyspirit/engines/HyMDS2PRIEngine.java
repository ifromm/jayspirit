...
/**
 * This engine creates a probabilistic relational index (PRI) file from a
 * multi-dimesional space (MDS) file. See hy_mds2pri manual for further details.
 * 
 ...
 *
 */
public class HyMDS2PRIEngine extends HyEngine {
    private static String ENGINE_NAME = "hy_mds2pri";
     ...
     * determined
     */
    public HyMDS2PRIEngine() throws HySpiritException {
        super(ENGINE_NAME);
    }
    ...
    /**
     * Invoke this before you create a new HyMDS2PRIEngine object to use 
     * {@code hyp_mds2pri} instead of {@code hy_mds2pri}
     *
     */
    public static void useHyp() {
        ENGINE_NAME = "hyp_mds2pri";
    }
    
    /**
     * Invoke this before you create a new HyMDS2PRIEngine object to use
     * {@code hy_mds2pri} instead of {@code hyp_mds2pri} (this is the default)
     *
     */
    public static void useHy() {
        ENGINE_NAME = "hy_mds2pri";
    }    
    ...
    /**
     * The columns for which the index should be created. See hy_mds2pri manual
     * for further details.
    ...
    /**
     * Sets the file name in which the PRI is stores (if not specified, it is
     * stored in "a.pri")
     * @param outputFile the name of the PRI output file
     */
