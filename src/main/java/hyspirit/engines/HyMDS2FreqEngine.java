...
public class HyMDS2FreqEngine extends HyAnalysisEngine {
    ...
    private final String hy_mds2freq = null;
    ...
    private static final String ENGINE_NAME = "hyp_mds2freq";
     ...
     *             if the HySiprit envirnoment cannot be determined
     */
    ...
    /**
     * Whether or not to take into account the tuple probabilities specified in
     * the inut file. See hy_mds2freq manual for further details.
     * 
     * @param probabilistic
     */
	...
	if (probabilistic)
	    ...
	    this.probabilistic = "noprobabilistic";
    }

    /**
     * Whether or not to print the average frequency. See hy_mds2freq manual for
     * further details.
     * 
     * @param avg
     */
     ...
     * 
     * @param stream
     *            true if stream option should be set, false for nostream option
     */
    public void setStream(boolean stream) {
	if (stream)
	    this.stream = "stream";
	else
	    this.stream = "nostream";
    }
