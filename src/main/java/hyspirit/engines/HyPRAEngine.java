 ...
 * a client or server mode. In client mode, a hostname and port of a running
 * hy_pra server must be given. The run() method does not have any effect in
 * client mode. In server mode, a new hy_pra process is started. You must invoke
 * the run() method after setting all required parameters.
 * <p>
 * Example: <blockquote>
 *
 * <pre>
 ...
 *
 * <b>Important</b>: Invoke <code>destroy()</code> once you don't need the
 * object any more - this will kill all spawned subthreads which might otherwise
 * run endlessly!
 * <p>
 *
 * @author Ingo Frommholz &lt;ingo@is.informatik.uni-duisburg.de&gt;
...
public class HyPRAEngine extends HyInferenceEngine {
     ...
     * This simple routine checks if there is a dot at the end of each line. If
     * not, a dot is appended. Assumes one PRA instruction per line. Also
     * converts "?- PROJECT" to "?- PROJECT independent", so if you assume
     * something else than independence, you need to modify this method. <br/>
     * This is a very dirty hack and should be replaced with something more
     * intelligent.
     *
     * @param praCode
     *            the PRA code to be fixed.
    ...
    /**
     * XXX Does verbose write to STDOUT? --> Dangerous with tuples! Sets or
     * unsets the verbosity for "eval". See hy_pra manual for further details.
     *
     * @param verboseEval
     */
    ...
    /**
     * Sets evaluation method for probability computation to 'lazy'. See hy_pra
     ...
     *
     * @param maxNum
     *            maximum number of elements in disjunction
     */
    ...
    /**
     * Sets the maxmimum number of tuples loaded. See hy_pra manual for further
     * details.
     *
     * @param maxNum
