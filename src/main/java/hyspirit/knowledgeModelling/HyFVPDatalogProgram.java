...
import hyspirit.engines.HyFVPDatalogEngine;
import hyspirit.engines.HyInferenceEngine;
import hyspirit.util.HySpiritException;

public class HyFVPDatalogProgram extends HyProgram {
    
    private final String layer = "FVPDatalog";
    
    public HyInferenceEngine inferenceEngine () {
	if (inferenceEngine == null)
	try {
	    inferenceEngine = new HyFVPDatalogEngine();
	}
